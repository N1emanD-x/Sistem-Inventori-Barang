...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $update = "UPDATE kategori SET nama_kategori='$nama_kategori', deskripsi='$deskripsi' WHERE id='$id'";
...
<head>
    ...
    <title>Edit Kategori — Inventori</title>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .form-control { background-color: #111315; border: 1px solid #2a2d32; color: #f0f0f0; border-radius: 8px; padding: 10px 14px; font-size: 0.88rem; }
        .form-control:focus { background-color: #111315; border-color: #495057; color: #f0f0f0; box-shadow: none; }
        .btn-simpan { background: #f0f0f0; color: #111315; border: none; border-radius: 6px; padding: 8px 20px; font-size: 0.85rem; font-weight: 600; transition: background 0.15s; }
...
<div id="main">
    ...
    <div class="content">
        <div class="form-card">
            <div class="form-card-title">Form Edit Kategori</div>
