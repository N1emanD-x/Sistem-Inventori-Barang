...
<head>
    ...
    <title>Kategori — Inventori</title>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .sidebar-brand {
            padding: 24px 20px; font-size: 0.95rem;
            font-weight: 600; color: #f0f0f0;
            border-bottom: 1px solid #2a2d32;
        }
        .sidebar-brand span {
            color: #6c757d; font-weight: 400;
            font-size: 0.75rem; display: block; margin-top: 2px;
        }
        .sidebar-nav { flex: 1; padding: 12px 0; }
        .sidebar-nav a {
            display: flex; align-items: center; gap: 10px;
            padding: 10px 20px; color: #6c757d;
            text-decoration: none; font-size: 0.88rem; transition: all 0.15s;
        }
        .sidebar-nav a:hover { color: #f0f0f0; background-color: #22262b; }
        .sidebar-nav a.active {
            color: #f0f0f0; background-color: #22262b;
        ...
        #topbar .page-title { font-size: 0.95rem; font-weight: 600; color: #f0f0f0; }
        ...
        .btn-logout {
            ...
            color: #6c757d; border-radius: 6px; padding: 5px 12px;
        ...
        .btn-tambah {
            background: #f0f0f0; color: #111315;
        ...
        .table tbody td {
            ...
            color: #adb5bd; font-size: 0.88rem;
        ...
        .btn-edit {
            background: transparent; border: 1px solid #2a2d32;
            color: #adb5bd; border-radius: 6px;
        ...
        .alert-success-dark {
            background: #1a2a1a; border: 1px solid #2a5c2a;
            color: #86efac; border-radius: 8px;
            padding: 10px 14px; font-size: 0.85rem; margin-bottom: 20px;
        }
    </style>
</head>
<body>
...
<div id="sidebar">
    <div class="sidebar-brand">
        Inventori <span>Sistem Manajemen Barang</span>
    </div>
        ...
        <div class="table-card">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><?= $no++ ?></td>
                        <td style="color:#f0f0f0;"><?= $row['nama_kategori'] ?></td>
                        <td><?= $row['deskripsi'] ?? '-' ?></td>
                    ...
                    <tr>
                        <td colspan="5" style="text-align:center; color:#6c757d; padding:32px;">
