...
/* =============================================
   ...
   FUNGSI: Form tambah barang baru
============================================= */
include '../config.php';
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "INSERT INTO barang (nama_barang, id_kategori, stok, harga)
              VALUES ('$nama_barang', '$id_kategori', '$stok', '$harga')";
...
<head>
    ...
    <title>Tambah Barang — Inventori</title>
...
<div id="main">
    ...
    <div class="content">
        <div class="form-card">
            <div class="form-card-title">Form Tambah Barang</div>
